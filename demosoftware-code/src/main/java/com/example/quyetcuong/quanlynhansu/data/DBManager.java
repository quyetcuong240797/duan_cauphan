...
public class DBManager extends SQLiteOpenHelper {
    ...
    private static final String THOI_GIAN_LAM_VIEC="thoi_gian_lam_viec";
    ...
    public void addStudent(NhanVien nhanVien){
        ...
        values.put(THOI_GIAN_LAM_VIEC, nhanVien.getThoigianlamviec());
    ...
    public NhanVien getNhanVienById(int id){
        ...
        Cursor cursor = db.query(TABLE_NAME, new String[] { ID,
                        NAME,ADDRESS,PHONE_NUMBER,EMAIL,CHUC_VU,LUONG,THOI_GIAN_LAM_VIEC }, ID + "=?",
                new String[] { String.valueOf(id) }, null, null, null, null);
        if (cursor != null)
            cursor.moveToFirst();

        NhanVien nhanVien = new NhanVien(cursor.getString(1),cursor.getString(2),cursor.getString(3),cursor.getString(4),cursor.getString(5),cursor.getString(6),cursor.getString(7),cursor.getString(8));
        cursor.close();
        db.close();
        return nhanVien;
    }
    ...
    public List<NhanVien> getAllStudent() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                nhanVien.setLuong(cursor.getString(7));
                nhanVien.setThoigianlamviec(cursor.getString(8));
